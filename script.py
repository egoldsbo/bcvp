...
def play_video(video_path):
    ...
    play_command = ['sudo', '-u', 'pi', 'cvlc', '--no-audio', '--play-and-exit', video_path]
...
while True:
    ...
    video_file_name = input("Enter the name of the video file to play, 'gitupdate' to update, or 'exit' to quit: ")
